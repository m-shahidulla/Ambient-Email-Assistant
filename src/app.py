...
from src.gmail_service import fetch_unread_email, send_reply, create_calendar_event
from src.triage import triage
from src.agent import agent
from src.memory import load_memory, update_memory
...
if st.session_state.current_email:
    ...
    if decision == "ignore":
        from src.gmail_service import move_to_spam
